 ...
 */
@TableName("daoju_collection")
public class DaojuCollectionView extends DaojuCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String daojuCollectionValue;
	...
	public DaojuCollectionView() {

	}

	public DaojuCollectionView(DaojuCollectionEntity daojuCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, daojuCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getDaojuCollectionValue() {
				return daojuCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setDaojuCollectionValue(String daojuCollectionValue) {
				this.daojuCollectionValue = daojuCollectionValue;
			}
