...
public class DaojuOrderView extends DaojuOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 订单类型的值
		*/
		private String daojuOrderValue;
		/**
		* 支付类型的值
		*/
		private String daojuOrderPaymentValue;
	...
	public DaojuOrderView() {

	}

	public DaojuOrderView(DaojuOrderEntity daojuOrderEntity) {
		try {
			BeanUtils.copyProperties(this, daojuOrderEntity);
			...
			* 获取： 订单类型的值
			*/
			public String getDaojuOrderValue() {
				return daojuOrderValue;
			}
			/**
			* 设置： 订单类型的值
			*/
			public void setDaojuOrderValue(String daojuOrderValue) {
				this.daojuOrderValue = daojuOrderValue;
			}
			/**
			* 获取： 支付类型的值
			*/
			public String getDaojuOrderPaymentValue() {
				return daojuOrderPaymentValue;
			}
			/**
			* 设置： 支付类型的值
			*/
			public void setDaojuOrderPaymentValue(String daojuOrderPaymentValue) {
				this.daojuOrderPaymentValue = daojuOrderPaymentValue;
			}
