...
public class DaojuCommentbackView extends DaojuCommentbackEntity implements Serializable {
	...
	public DaojuCommentbackView() {

	}

	public DaojuCommentbackView(DaojuCommentbackEntity daojuCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, daojuCommentbackEntity);
