...
var centerMenu = [
    ...
    ,{
        name: '道具收藏',
        url: '../daojuCollection/list.jsp'
    }
    ,{
        name: '道具订单',
        url: '../daojuOrder/list.jsp'
    }
...
var adminurl =  "http://localhost:8080/youxixunidaojujiaoyiwangzhan/jsp/login.jsp";
