    ...
    <div class="ng-container ng-fault">
        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div style="margin-top: 2em;">
                        <div v-for="(item,index) in daojuList" v-bind:key="index"  class="col-md-3 list-grid">
                            <div @click="jumpCheck('../daoju/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" class="list-img">
                                <img :src="item.daojuPhoto?item.daojuPhoto.split(',')[0]:''" class="img-responsive" style="height: 350px;width:100%;" />
                                <div class="textbox"></div>
                                <h4 >名称:{{item.daojuName}}</h4>
                                <p v-if="item.daojuNewMoney != null" style="color: red;" >￥{{item.daojuNewMoney}}</p>
                            </div>
                        </div>
                    </div>
                </div>
