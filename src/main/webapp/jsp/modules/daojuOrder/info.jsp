            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">道具订单登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="daojuOrderUuidNumber" name="daojuOrderUuidNumber" class="form-control"
                                               v-model="ruleForm.daojuOrderUuidNumber" readonly>
                                    </div>

                                <input id="daojuId" name="daojuId" v-model="ruleForm.daojuId" readonly type="hidden">
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="daojuOrderTruePrice" name="daojuOrderTruePrice" class="form-control"
                                               v-model="ruleForm.daojuOrderTruePrice" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="daojuOrderCourierName" name="daojuOrderCourierName" class="form-control"
                                               v-model="ruleForm.daojuOrderCourierName" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="daojuOrderCourierNumber" name="daojuOrderCourierNumber" class="form-control"
                                               v-model="ruleForm.daojuOrderCourierNumber" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>订单类型</label>
                                    <input style="width: 450px" id="daojuOrderValue" name="daojuOrderValue" class="form-control"
                                           v-model="ruleForm.daojuOrderValue" readonly>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>支付类型</label>
                                    <input style="width: 450px" id="daojuOrderPaymentValue" name="daojuOrderPaymentValue" class="form-control"
                                           v-model="ruleForm.daojuOrderPaymentValue" readonly>
                                </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "daojuOrder/info/" + id,
